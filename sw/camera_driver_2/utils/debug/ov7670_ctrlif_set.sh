...
w 0x3A 0x04       # TSLB
[ "$COM7_VAL" = "0x05" ] && w 0xB0 0x8C  # color fix: required for Processed Bayer RGB
...
echo "=== Register check ==="
FAIL=0
chk 0x12 $COM7_VAL  COM7
chk 0x3A 0x04       TSLB
[ "$COM7_VAL" = "0x05" ] && chk 0xB0 0x8C 0xB0
chk 0x0C 0x00       COM3
chk 0x3E 0x00       COM14
chk 0x70 0x3A       SCALING_XSC
chk 0x71 0x35       SCALING_YSC
...
chk 0x13 0xE7       COM8
chk 0x3B 0x12       COM11
chk 0x9D 0x4C       BD50ST
chk 0x9E 0x3F       BD60ST
chk 0xA5 0x05       BD50MAX
chk 0xAB 0x07       BD60MAX
echo ""
if [ $FAIL -eq 0 ]; then
    echo "=== ALL OK ==="
else
