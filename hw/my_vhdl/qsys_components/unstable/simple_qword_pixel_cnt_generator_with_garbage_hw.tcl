# simple_qword_pixel_cnt_generator_with_garbage_hw.tcl

#
# simple_qword_pixel_cnt_generator_with_garbage "Simple Qword Pixel-Counter Generator" v1.2
...
#
# module simple_qword_pixel_cnt_generator_with_garbage
#
set_module_property DESCRIPTION ""
set_module_property NAME simple_qword_pixel_cnt_generator_with_garbage
...
set_module_property DISPLAY_NAME "Simple Qword Pixel-Counter Generator with Garbage"
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL simple_qword_pixel_cnt_generator_with_garbage
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file simple_qword_pixel_cnt_generator_with_garbage.vhd VHDL PATH simple_qword_pixel_cnt_generator_with_garbage.vhd TOP_LEVEL_FILE
...
add_parameter GARBAGE_QWORDS INTEGER 4 ""
set_parameter_property GARBAGE_QWORDS DEFAULT_VALUE 4
set_parameter_property GARBAGE_QWORDS DISPLAY_NAME "Garbage Qwords between EOP and SOP"
set_parameter_property GARBAGE_QWORDS TYPE INTEGER
set_parameter_property GARBAGE_QWORDS UNITS None
set_parameter_property GARBAGE_QWORDS ALLOWED_RANGES 1:1024
set_parameter_property GARBAGE_QWORDS DESCRIPTION "Number of all-F qwords injected between EOP and next SOP (0 = disabled)"
set_parameter_property GARBAGE_QWORDS HDL_PARAMETER true
...
proc validate_frame_size {} {
    ...
    set g [get_parameter_value GARBAGE_QWORDS]
    set total [expr {$w * $h}]
    if {$total > 4294967295} {
        send_message error "WIDTH * HEIGHT ($total) exceeds 32-bit unsigned range (max 4294967295)"
    }
    if {[expr {$total + $g + 1}] > 4294967295} {
        send_message error "WIDTH * HEIGHT + GARBAGE_QWORDS + 1 exceeds 32-bit unsigned range"
    }
}
