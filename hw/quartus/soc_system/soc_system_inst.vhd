	component soc_system is
		port (
			...
			fpga_button_pio_external_connection_export : in    std_logic_vector(3 downto 0)  := (others => 'X'); -- export
			fpga_dipsw_pio_external_connection_export  : in    std_logic_vector(9 downto 0)  := (others => 'X'); -- export
			fpga_led_pio_external_connection_export    : out   std_logic_vector(9 downto 0);                     -- export
	...
	u0 : component soc_system
		port map (
			...
			fpga_button_pio_external_connection_export => CONNECTED_TO_fpga_button_pio_external_connection_export, -- fpga_button_pio_external_connection.export
			fpga_dipsw_pio_external_connection_export  => CONNECTED_TO_fpga_dipsw_pio_external_connection_export,  --  fpga_dipsw_pio_external_connection.export
			fpga_led_pio_external_connection_export    => CONNECTED_TO_fpga_led_pio_external_connection_export,    --    fpga_led_pio_external_connection.export
